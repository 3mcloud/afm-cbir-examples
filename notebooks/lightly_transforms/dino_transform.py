...
from lightly_transforms.multi_view_transform import MultiViewTransform
from lightly_transforms.rotation import random_rotation_transform
from lightly_transforms.solarize import RandomSolarization
from lightly_transforms.utils import IMAGENET_NORMALIZE
from lightly_transforms.gaussian_blur import GaussianBlur
...
class DINOViewTransform:
    def __init__(
        ...
        transform = [
            ...
            #T.ToTensor(), #CHANGED THIS LINE FOR FLOAT32 UTILIZATION
        ]
        if normalize:
    ...
    def __call__(self, image: Union[Tensor, Image]) -> Tensor:
        ...
        if len(image.shape)==2:
            image = image[None,:,:].repeat(3,1,1) #Spanning 3 color channels
